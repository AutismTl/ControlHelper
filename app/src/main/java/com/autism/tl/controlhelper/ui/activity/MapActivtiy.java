 ...
 */
public class MapActivtiy extends Activity implements RadarSearchListener,RadarUploadInfoCallback,View.OnClickListener{
    ...
    public void uploadOnceClick() {
        if (pt == null) {
            Toast.makeText(MapActivtiy.this, "未获取到位置", Toast.LENGTH_LONG).show();
            return;
        }else {
    ...
    public void uploadContinueClick() {
        if (pt == null) {
            ...
            Toast.makeText(MapActivtiy.this, "开始自动上传位置", Toast.LENGTH_LONG).show();
        }
    }
    /**
     * 实现上传callback，自动上传
    ...
    public void stopUploadClick() {
        ...
        Toast.makeText(MapActivtiy.this, "已停止自动上传", Toast.LENGTH_LONG).show();
    }
    ...
    public void clearInfoClick() {
        ...
        Toast.makeText(MapActivtiy.this, "已清除当前位置信息", Toast.LENGTH_LONG).show();
    }
